    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_published', models.BooleanField(default=False, help_text='Este campo deve ser marcadopara a post ser exibido publicamente')),
                ('content', models.TextField()),
                ('cover', models.ImageField(blank=True, default='', upload_to='posts/%Y/%m/')),
                ('cover_in_post_content', models.BooleanField(default=True, help_text='Se marcado exibirá a capa dentro do conteúdo do post.')),
